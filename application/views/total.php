...
<meta name="keywords" content="logitech, maus, tastatur, peripherie, audi">
...
<!--				<p id="text_content">-->
					<p id="text_content" class="level1l">Produkt 1</p>
					<p id="text_content" class="level2l">
					Kategorie 1.1<br>
					Kategorie 1.2<br>
					Kategorie 1.3<br>
					</p>
					<p id="text_content" class="level1l">Produkt 2</p>
					<p id="text_content" class="level2l">
					Kategorie 2.1<br>
					Kategorie 2.2<br>
					Kategorie 2.3<br>
					</p>
					<p id="text_content" class="level1l">Produkt 3</p>
					<p id="text_content" class="level2l">
					Kategorie 3.1<br>
					Kategorie 3.2<br>
					Kategorie 3.3<br>
					</p>
					<p id="text_content" class="level1l">Produkt 4</p>
					<p id="text_content" class="level2l">
					Kategorie 4.1<br>
					Kategorie 4.2<br>
					Kategorie 4.3<br>
		...
		<div id="footer">
		.:: Casestudy Internet und Intranettechnologien III :: Copyright 2010 by Z2H Design ::.
		</div>
</div>
