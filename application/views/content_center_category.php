...
<h1> <? echo $h1[0]->KategorieName ?> </h1>
        ...
        <center><img id="<?= "picture".$artikel->nummer; ?>" src="<? if (!empty($artikel->bildname))
			echo "/articleimages/".$artikel->bildname[0]; else echo "/images/products/mouse1.jpg"; ?>" height="111"> 
		</center>
        </div>
        ...
        <center>
        	<? for ($i=0; $i<count($artikel->bildname);$i++){
        		if ($i>0) print ' | ';
        		print ('<a class="a2" href=\'javascript:changePic("picture'.$artikel->nummer.'","/articleimages/'.$artikel->bildname[$i].'") \'>'.($i+1)."</a>");
        	}
        	?>
        ...
        <div id="content_center_item_right">
          ...
          <table width="348" border="0">
            <tr>
              ...
              echo '<img src="/images/feature_point.jpg" alt="">';
              }
              ?>
              </td>
            </tr>
