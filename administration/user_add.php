...
if(isset($_POST['txtVorname'])) 
{
  $objUser=New User();
  $objUser->CreateUser($_POST);
}
?>
	...
	<div id="content">
		...
		<FORM method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
		  <table style="width: 100%">
		    <tr>
			  <td style="width: 181px">Vorname:</td>
			  <td><input name="txtVorname" type="text" style="width: 220px" />&nbsp;</td>
		   	</tr>
		    <tr>
			  <td style="width: 181px">Nachname:</td>
			  <td><input name="txtNachname" type="text" style="width: 220px" />&nbsp;</td>
		   	</tr>
		    <tr>
			  <td style="width: 181px">Loginname:</td>
			  <td><input name="txtLogin" type="text" style="width: 220px" />&nbsp;</td>
		   	</tr>
		    <tr>
			  <td style="width: 181px">Passwort:</td>
			  <td><input name="txtPasswort" type="password" style="width: 220px" />&nbsp;</td>
		   	</tr>
			<tr>
