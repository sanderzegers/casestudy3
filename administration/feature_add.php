...
if(isset($_POST['txtFeatureBezeichnung']))
{
  $objFeature=New Feature();
  $objFeature->CreateFeature($_POST);
}
?>
...
<div id="container">
	...
	<div id="content">
        ...
        <h1>Feature hinzufügen</h1>
        </p><?php errorcheck(); ?>
		
		<FORM method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
		  <table style="width: 100%">
		    <tr>
			  <td style="width: 181px">Feature:</td>
			  <td><input name="txtFeatureBezeichnung" type="text" style="width: 220px" />&nbsp;</td>
		   	</tr>
			<tr>
